...
**Desktop (ab 960 px)**: drei Bereiche bei 1160 px Gesamtbreite.

- Oben links, feste Spalte von 400 px: Ampel, Phasenleiste, Motoren, Checkliste. Das ist die Antwort auf „Was tun?".
- Oben rechts: Zyklus-Uhr und Position. Das ist die Einordnung.
- Darunter über die volle Breite: Indikator-Kacheln im Dreierraster, Verlauf, Journal. Das sind die Belege.

Die beiden oberen Bereiche sind absichtlich etwa gleich hoch. Eine kurze Spalte neben einer langen wirkt unfertig, und die Kacheln nutzen die volle Breite besser als eine schmale Spalte. Auf dem Handy stapelt sich alles in derselben Reihenfolge.
...
**Zyklus-Uhr.** Ein waagrechter Zeitstrahl vom letzten Allzeithoch bis 720 Tage nach dem geschätzten nächsten Halving. Das Ende ist bewusst so weit gewählt, dass das Top-Fenster vollständig hineinpasst; eine kürzere Achse schneidet den wichtigsten Bereich ab. Farbig hinterlegt sind das historische Tief-Fenster (9 bis 16 Monate nach dem Hoch, teal) und das Top-Fenster (450 bis 640 Tage nach dem Halving, coral). Markiert sind das letzte Hoch, das geschätzte nächste Halving und die Heute-Linie; Beschriftungen an den Rändern werden linksbündig beziehungsweise rechtsbündig gesetzt, damit sie nicht abgeschnitten werden. Darunter eine Legende und der Hinweis „Muster, keine Prognose".

**Deine Position.** BTC-Bestand, Cash, Kernposition (mit Schloss-Symbol), Reserve. Dazu die Tranchen des laufenden Zyklus mit vier Zuständen: **offen** (noch nicht ausgelöst), **fällig** (in dieser Woche ausgelöst und noch nicht erledigt, amber), **erledigt** (teal mit Haken) und **übersprungen** (durchgestrichen). Ausserdem zeigt eine Tranche, die in einer früheren Woche ausgelöst wurde, das Datum in neutraler Farbe. Wichtig: Ein gesetztes Datum bedeutet nicht „fällig". Die Tranchenliste trägt die Werte des laufenden Zyklus bis zum nächsten Eintritt in Phase ① mit, in Phase ④ stünden sonst alle sechs Chips fälschlich auf fällig. Hinweis: „Nur auf diesem Gerät gespeichert." Ohne Eingabe zeigt die Karte: „Trag deinen Bestand ein, dann rechnet die Seite die Tranchen in CHF und BTC aus."
